...
public class ATMhome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        withdraaw = new javax.swing.JButton();
        ...
        jPanel1.add(c, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, 90, 50));
        ...
        jPanel1.add(d, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, 90, 50));
        ...
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 50, 140, 50));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(240, 240, 240));
        jLabel4.setText("WithDraw");
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 180, 100, 50));
        ...
        jPanel1.add(balance, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 70, 90, 50));

        withdraaw.setText("<<<<");
        withdraaw.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        withdraaw.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                withdraawActionPerformed(evt);
            }
        });
        jPanel1.add(withdraaw, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 200, 90, 50));
        ...
        jLabel6.setText("Piggy bank ");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/piggy-bank.png"))); // NOI18N
    ...
    private void withdraawActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_withdraawActionPerformed
        this.setVisible(false);
        new Withdraw(cus).setVisible(true);
    }//GEN-LAST:event_withdraawActionPerformed
    ...
    private javax.swing.JButton withdraaw;
