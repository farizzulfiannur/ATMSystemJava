...
public class confirm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingin Mencetak Resi ? ");
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, -1, 20));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(240, 240, 240));
        jLabel3.setText("IYA");
        jPanel4.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 70, 60, 50));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(240, 240, 240));
        jLabel4.setText("TIDAK");
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, 70, 50));
        ...
        jPanel1.add(c, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 70, 90, 60));

        iya.setText("<<<<");
        iya.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        iya.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                iyaActionPerformed(evt);
            }
        });
        jPanel1.add(iya, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 80, 90, 60));

        tidak.setText("<<<<");
        tidak.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        tidak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tidakActionPerformed(evt);
            }
        });
        jPanel1.add(tidak, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 190, 90, 60));
        ...
        jPanel1.add(d, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 90, 60));
...
private void writeFile(String data){
    ...
    private void iyaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iyaActionPerformed
        if (cus.withraw(amount)){
            JOptionPane.showMessageDialog(null,"Name : "+cus.getName()+"\n"+"Account : #"+cus.getAccountNo()+"\n"+"Sisa Tabungan : "+cus.getBalance());
            list.Withraw(cus);
            writeFile(list.alldata());
        }
        else {
    ...
    private javax.swing.JButton iya;
